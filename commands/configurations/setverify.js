    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            if (channel.id === a && role.id === b) {
                ...
                client.guilds.cache.get(message.guild.id).channels.cache.get(channel.id).send(`
                Hello Welcome to **${guild.name}**
                To verify say \`${prefix}verify
                this is to insure safety of this server
                 <:lipbite:834608852372160523>`)
