...
if (channel === null) return;
    ...
    const query = new MessageEmbed()
      .setDescription(`:x:   | Please write a sad decline message :(`)
      .setColor("FF2052")
      
    const reply = new MessageEmbed()
      .setDescription(`:white_check_mark:   | Successfully declined the Suggestion.`)
      .setColor("00FFFF")
  ...
  return message.channel.send(noMessage);
    ...
    const embed = new MessageEmbed()
      .setDescription(`Your suggestion got declined rip :white_check_mark:  . **[Message Link](https://discord.com/channels/${message.guild.id}/${channel}/${messageID})**`)
      .setColor("BLUE")
      user.send(embed)
